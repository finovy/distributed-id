...
public final class RedisGrpc {
  ...
  public static RedisBlockingStub newBlockingStub(
    ...
    return new RedisBlockingStub(channel);
  }
  ...
  public static RedisFutureStub newFutureStub(
      io.grpc.Channel channel) {
    return new RedisFutureStub(channel);
  }
  ...
  /**
   */
  public static final class RedisStub extends io.grpc.stub.AbstractStub<RedisStub> {
    private RedisStub(io.grpc.Channel channel) {
      super(channel);
    }
    ...
    @Override
    protected RedisStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
  ...
  /**
   */
  public static final class RedisBlockingStub extends io.grpc.stub.AbstractStub<RedisBlockingStub> {
    private RedisBlockingStub(io.grpc.Channel channel) {
      super(channel);
    }
    ...
    @Override
    protected RedisBlockingStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
  ...
  /**
   */
  public static final class RedisFutureStub extends io.grpc.stub.AbstractStub<RedisFutureStub> {
    private RedisFutureStub(io.grpc.Channel channel) {
      super(channel);
    }
    ...
    @Override
    protected RedisFutureStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
  ...
  private static final class RedisDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    @Override
      ...
      synchronized (RedisGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              .setSchemaDescriptor(new RedisDescriptorSupplier())
